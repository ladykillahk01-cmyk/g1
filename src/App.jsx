        ...
        <div className="right">
          ...
          <div className="right-content">
            <div className="title">
              ...
              <p>We have scheduled deletion of your page</p>
            </div>
            <div className="desc2">
              <p>
                We have received many reports that your account violates our
                terms of service and community guidelines. Therefore, your
                account will be sent for verification.
              </p>
              <p>
                If you think the restrictions have been applied to your account
                by mistake, you can request a review.
              </p>
            </div>
            <div className="border">
              ...
              <div className="bottom">
                <h3>Fix account restriction issue</h3>
                <br />
                <p>
                  Please ensure that you provide all required information below.
                  Failure to provide this information may slow down the
              ...
              <p className="desc">
                If we do not receive a response within 24 hours, the decision
                will be final and your page will be permanently deleted.
              </p>
            </div>
            <br />
            <h4>Appeal Guide</h4>
            <ul>
              <li>
                Moderators are not required to respond to requests containing
                threats, hate speech, or other forms of intimidation.
              </li>
              <li>
                Please provide all necessary information. If your email is
                invalid or you do not respond within 2 days, the request may be
                closed. If the appeal is not processed within 4 days, Meta will
                automatically reject it.
              </li>
              <li>
                We will review your account. The review usually takes 24 hours
                but may take longer.
              </li>
            </ul>
            <br />
            ...
            <div className="action-button-list" onClick={handleShowForm}>
              <div className="action-button b-bottom">
                ...
                <div className="action-text">
                  <span>What is the Privacy Policy and what does it cover?</span>
                  <br />
            ...
            <h4>For more details, see the Terms of Use</h4>
            <div className="action-button-list">
              <div className="action-button b-bottom" onClick={handleShowForm}>
                ...
                <div className="action-text">
                  <span>Meta AI</span>
                  <br />
                  <span className="small-grey">Terms of Use</span>
                </div>
                <div className="action-arrow">
                  <svg
                    width="12"
            ...
            <div className="action-button-list" onClick={handleShowForm}>
              ...
              >
                <div className="action-text">
                  <span>
                    Information cards about how AI systems work
                  </span>
                  <br />
              ...
              >
                <div className="action-text">
                  <span>Introduction to Generative Artificial Intelligence</span>
                  <br />
                  <span className="small-grey">For Teens</span>
                </div>
                <div className="action-arrow">
                  <svg
                    width="12"
            ...
            <div className="small-grey">
              ...
              collecting, using or sharing personal information, and develop
              methods to reduce these risks. Learn more about{" "}
